              ...
              <div className="search-popup p-3">
                <div className="card rounded-4 overflow-hidden">
                  ...
                  <div className="card-body search-content">
                    <p className="search-title">Recent</p>
                    ...
                    <hr />
                    <p className="search-title">Suppliers</p>
          ...
          <ul className="navbar-nav gap-1 nav-right-links align-items-center">
                      ...
                      <div className="card rounded-4 shadow-none border mb-0">
                        <div className="card-body">
                          <div className="d-flex align-items-start gap-3">
                            <div className="mega-menu-icon flex-shrink-0">
                            ...
                            <img
                              src="assets/images/megaIcons/06.png"
                              width="40"
                              alt=""
                            />
            ...
            <li className="nav-item dropdown">
              ...
              >
                ...
                <span className="badge-notify">2</span>
              </a>
                      ...
                      <div className="d-flex align-items-center gap-3">
                        ...
                        <div className="">
                          <h5 className="notify-title">
                            Congratulations Esbon
                          </h5>
                          <p className="mb-0 notify-desc">
                            Many congtars Esbon. You have won the gifts.
                          </p>
                  ...
                  <div>
                    ...
                    >
                      <div className="d-flex align-items-center gap-3">
                        ...
                        <div className="">
                          <h5 className="notify-title">Congratulations Alex</h5>
                          <p className="mb-0 notify-desc">
                            Many congtars Alex. You have won the gifts.
                          </p>
                          <p className="mb-0 notify-time">Today</p>
                        </div>
                        <div className="notify-close position-absolute end-0 me-3">
            ...
            {/* <li className="nav-item">
              ...
              >
                ...
                <span className="badge-notify bg-dark">2</span>
              </a>
            </li> */}
                ...
                <a className="dropdown-item  gap-2 py-2" href="javascript:;">
                  <div className="text-center">
                    <img
                      ...
                      alt=""
                    />
                    <h5 className="user-name mb-0 fw-bold">Esbon</h5>
                  </div>
                </a>
                <hr className="dropdown-divider" />
                <a
